...
#include "AssetDefinition_GameplayAttributeSet.generated.h"

/**
 * Modern UE5 Asset Definition for Gameplay Attribute Sets.
 */
UCLASS()
class UAssetDefinition_GameplayAttributeSet : public UAssetDefinition_Blueprint
{
	GENERATED_BODY()
