...
#include "AssetDefinition_GameplayEffectExecutionCalculation.generated.h"

UCLASS()
class UAssetDefinition_GameplayEffectExecutionCalculation : public UAssetDefinition_Blueprint
{
	GENERATED_BODY()
