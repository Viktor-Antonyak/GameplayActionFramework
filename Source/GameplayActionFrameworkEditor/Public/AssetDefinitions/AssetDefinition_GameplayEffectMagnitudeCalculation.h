...
#include "AssetDefinition_GameplayEffectMagnitudeCalculation.generated.h"

UCLASS()
class UAssetDefinition_GameplayEffectMagnitudeCalculation : public UAssetDefinition_Blueprint
{
	GENERATED_BODY()
